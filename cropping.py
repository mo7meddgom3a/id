...
def flipp(img):
    ...
    # Correct the path to your model file
    ...
    # print("Type of first element in results:", type(first_result))
    # print("Available attributes in the first element:", dir(first_result))

    # # Add code here to print the first element directly, if it's not a complex object
    # print("Content of the first element:", first_result)
...
# image = cv2.imread(r"C:\Users\moham\Downloads\IMG20231020183432.jpg")
